...
export type PartialAccountWithAvatar = Pick<Account, "id" | "acct" | "url" | "avatar" | "avatarStatic" | "locked" | "bot">;
...
export type FollowRequestNotificationGroup = NotificationGroupPlain<"follow_request">;
/**  Someone favourited one of your statuses */
export type FavouriteNotificationGroup = NotificationGroupWithStatusId<"favourite">;
...
export type QuotedUpdateNotificationGroup = NotificationGroupWithStatusId<"quoted_update">;
/** Someone signed up (optionally sent to admins) */
export type AdminSignUpNotificationGroup = NotificationGroupPlain<"admin.sign_up">;
/** A new report has been filed */
export type AdminReportNotificationGroup = NotificationGroupWithReport<"admin.report">;
/** Some of your follow relationships have been severed as a result of a moderation or block event */
export type SeveredRelationshipsNotificationGroup = NotificationGroupWithEvent<"severed_relationships">;
/** A moderator has taken action against your account or has sent you a warning */
export type ModerationWarningNotificationGroup = NotificationGroupWithModerationWarning<"moderation_warning">;
...
/** Group key identifying the grouped notifications. Should be treated as an opaque value. */
export type NotificationGroup = NotificationGroupRegistry[keyof NotificationGroupRegistry];
