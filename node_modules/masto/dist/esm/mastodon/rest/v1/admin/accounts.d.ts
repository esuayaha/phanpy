...
export interface AccountActionRegistry {
    none: never;
    disable: never;
    silence: never;
    sensitive: never;
...
export type AccountActionType = keyof AccountActionRegistry;
...
export interface Accounts$SelectActionResource {
    /**
...
export interface Accounts$SelectResource {
    action: Accounts$SelectActionResource;
    /**
...
export interface AccountsResource {
     ...
     * @see https://docs.joinmastodon.org/methods/admin/
     */
    list: Method<Paginator<Admin.Account[], ListAccountsParams>, ListAccountsParams>;
}
