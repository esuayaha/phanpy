import { type HttpMetaParams, type HttpResponse } from "../../../interfaces/index.js";
import { type Account, type Context, type PreviewCard, type ScheduledStatus, type Status, type StatusEdit, type StatusSource, type StatusVisibility, type Translation } from "../../entities/v1/index.js";
...
export type CreateStatusParams = CreateStatusParamsWithStatus | CreateStatusParamsWithMediaIds;
...
export interface StatusesResource {
     ...
     */
    create: {
        (params: CreateStatusParams, meta?: HttpMetaParams<"json">): Promise<Status>;
        (params: CreateScheduledStatusParams, meta?: HttpMetaParams<"json">): Promise<ScheduledStatus>;
        /** @experimental */
        $raw(params: CreateStatusParams, meta?: HttpMetaParams<"json">): Promise<HttpResponse<Status>>;
        /** @experimental */
        $raw(params: CreateScheduledStatusParams, meta?: HttpMetaParams<"json">): Promise<HttpResponse<ScheduledStatus>>;
    };
}
